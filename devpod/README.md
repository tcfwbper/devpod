...
### DevPod OS Definition and Image Parameters

| Name                       | Description                                                                                                             | Value                     |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| `operatingSystem`          | Operating system for DevPod. Allowed values: ubuntu, alpine                                                             | `ubuntu`                  |
| `ubuntu.image.registry`    | Development environment image registry                                                                                  | `REGISTRY_NAME`           |
| `ubuntu.image.repository`  | Development environment image repository                                                                                | `REPOSITORY_NAME/dev-env` |
| `ubuntu.image.tag`         | Development environment image tag (rebuild your image and set this value)                                               | `1.1.0-ubuntu`            |
| `ubuntu.image.digest`      | Development environment image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag | `""`                      |
| `ubuntu.image.pullPolicy`  | Development environment image pull policy                                                                               | `IfNotPresent`            |
| `ubuntu.image.pullSecrets` | Specify docker-registry secret names as an array                                                                        | `[]`                      |
| `ubuntu.image.debug`       | Set to true if you would like to see extra information on logs                                                          | `false`                   |
| `alpine.image.registry`    | Development environment image registry                                                                                  | `REGISTRY_NAME`           |
| `alpine.image.repository`  | Development environment image repository                                                                                | `REPOSITORY_NAME/dev-env` |
| `alpine.image.tag`         | Development environment image tag (rebuild your image and set this value)                                               | `1.1.0-alpine`            |
| `alpine.image.digest`      | Development environment image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag | `""`                      |
| `alpine.image.pullPolicy`  | Development environment image pull policy                                                                               | `IfNotPresent`            |
| `alpine.image.pullSecrets` | Specify docker-registry secret names as an array                                                                        | `[]`                      |
| `alpine.image.debug`       | Set to true if you would like to see extra information on logs                                                          | `false`                   |
...
| `auth.existingSecretPasswordKey` | Password key to be retrieved from existing secret                                                                                                   | `devpod-password` |
...
| `packages.apt`                                      | APT packages to install in Ubuntu DevPod pods.                                                                                                                                                                    | `[]`             |
| `packages.apk`                                      | APK packages to install in Alpine DevPod pods.                                                                                                                                                                    | `[]`             |
...
| `initWorkspace.image.tag`                                         | Init Workspace image tag (rebuild your image and set this value)                                                                                                                                                  | `1.0.1-init-workspace`    |
